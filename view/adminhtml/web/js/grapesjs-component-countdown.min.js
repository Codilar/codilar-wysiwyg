! function(e, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n(require("grapesjs")) :  "object" == typeof exports ? exports["grapesjs-component-countdown"] = n(require("grapesjs")) : e["grapesjs-component-countdown"] = n(e.grapesjs)
}(this, function(e) {
    return function(e) {
        function n(o) {
        ...
        var a = t(2),
            ...
            i = o(r),
            c = t(0);
        n.default = d.default.plugins.add("gjs-component-countdown", function(e) {
            ...
            (0, l.default)(e, t), (0, i.default)(e, t)
        })
    }, function(n, t) {
        n.exports = e
    }, function(e, n, t) {
        ...
        n.default = function(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                l = d.model,
                r = d.view,
                i = (s.model, s.view, t.countdownClsPfx);
            a.addType("countdown", {
                model: l.extend({
                    defaults: o({}, l.prototype.defaults, {
                        ...
                        script: function() {
                            var e = new Date("{[ startfrom ]}").getTime(),
                                n = this.querySelector("[data-js=countdown]"),
                                t = this.querySelector("[data-js=countdown-endtext]"),
                                o = this.querySelector("[data-js=countdown-day]"),
                                a = this.querySelector("[data-js=countdown-hour]"),
                                d = this.querySelector("[data-js=countdown-minute]"),
                                s = this.querySelector("[data-js=countdown-second]"),
                                l = this.gjs_countdown_interval;
                            l && l && clearInterval(l);
                            var r = function(e, n, t, l) {
                                    o.innerHTML = e < 10 ? "0" + e : e, a.innerHTML = n < 10 ? "0" + n : n, d.innerHTML = t < 10 ? "0" + t : t, s.innerHTML = l < 10 ? "0" + l : l
                                },
                                i = function() {
                                    ...
                                    r(d, s, l, i), a < 0 && (clearInterval(c), t.innerHTML = "{[ endText ]}", n.style.display = "none", t.style.display = "")
                                };
                            if (e) {
                                var c = setInterval(i, 1e3);
                                this.gjs_countdown_interval = c, t.style.display = "none", n.style.display = "", i()
                            } else r(0, 0, 0, 0)
                        }
                    })
                }, {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                a = e.BlockManager,
                d = t.countdownClsPfx,
                s = t.defaultStyle ? "<style>\n    ." + d + " {\n      text-align: center;\n      font-family: Helvetica, serif;\n    }\n\n    ." + d + "-block {\n      display: inline-block;\n      margin: 0 10px;\n      padding: 10px;\n    }\n\n    ." + d + "-digit {\n      font-size: 5rem;\n    }\n\n    ." + d + "-endtext {\n      font-size: 5rem;\n    }\n\n    ." + d + "-cont,\n    ." + d + "-block {\n      display: inline-block;\n    }\n  </style>" : "";
            t.blocks.indexOf(o.countdownRef) >= 0 && a.add(o.countdownRef, {
